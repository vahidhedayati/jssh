...
<div class="btn btn-block"><h5>WebSocket SSH in remoteForm (update a Div)</h5></div>
	<div  class="form-group form-condensed">
	
		<g:formRemote name="socketConnection" 
			url="[controller:'connectSsh', action:'process']"
       	 	update="myDiv"
    	>
		...
		<div class='row'>
			<div class='col-sm-12'>		
				...
				url="[controller:'connectSsh', action:'process']" update="myDiv"  value="Send" />
			</div>
		</div>	
	</g:formRemote>
</div>
