...
<div class="fieldcontain ${hasErrors(bean: uiterator, field: 'replacement', 'error')} required">
	<label for="replacement">
		<g:message code="jssh.replacement.label" default="replacement" />
		<span class="required-indicator">*</span>
	</label>
	<g:textField name="replacement" required="" value="${uiterator?.replacement}"/>
</div>
