...
class JsshService extends ConfService {
	...
	private void sshConnect(SshClient ssh, SessionChannelClient session,  String user, String userpass, String host, String usercommand, int port, Session userSession)  {
