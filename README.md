...
Configure SSH and SCP by adding properties to grails-app/conf/Config.groovy under the "jssh" key:
...
0.27-SNAPSHOT1	: 	Observation of log lines longer than screen caused previous release to extend line further than visible.
 ...
 0.27 	: 	Added Javascript to escapeHtml within socket/ajaxpoll pages. 
 			Response returned from backend if html was not displayed correctly.
 
 0.26 	:	Updated Environment development in JsshEndPoint, bug spotted on grails-wschat-plugin
 
 0.25-SNAPSHOT : Removed userCommand var within javascript - testing - appears to conflict on multi calls of taglib
